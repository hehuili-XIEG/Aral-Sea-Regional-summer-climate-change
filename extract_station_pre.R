...
write.table(nn,paste(savedir,"full_prcp_station_day_8486.txt",sep=""),quote = FALSE, sep=",",na = "NA",row.names=FALSE,col.names=FALSE,qmethod="double")
...
write.table(nn,paste(savedir,"real_prcp_station_day_8486.txt",sep=""),quote = FALSE, sep=",",na = "NA",row.names=FALSE,col.names=FALSE,qmethod="double")
...
write.table(nn,paste(savedir,"no_prcp_station_day_8486.txt",sep=""),quote = FALSE, sep=",",na = "NA",row.names=FALSE,col.names=FALSE,qmethod="double")
